				...
				<div class="card-content collapse show">
					<div class="card-body">
						<form action="{{ route('admin.author.update', $author->id) }}" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label>Year</label>
								<input type="text" name="year" id="year" class="form-control" value="{{ $author->year }}">
								@if($errors->has('year'))
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="short_description" id="short_description">{{ $author->short_description }}</textarea>
							...
							<div class="form-check form-group">
								<input type="checkbox" class="form-check-input" id="is_popular" name="is_popular" value="1" {{ $author->is_popular == 1 ? "checked" : "" }}>
